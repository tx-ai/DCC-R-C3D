...
#                (1,20,96,1,1),(1,20,96,1,1),(1,20,96,1,1),       (1,20,96,1,1),        sigma=3,   dim=[1,2,3,4]
def _smooth_l1_loss(bbox_pred, bbox_targets, bbox_inside_weights, bbox_outside_weights, sigma=1.0, dim=[1]):
    sigma_2 = sigma ** 2    # 9
    box_diff = bbox_pred - bbox_targets  # (1,20,96,1,1)
    in_box_diff = bbox_inside_weights * box_diff  # (1,20,96,1,1)
