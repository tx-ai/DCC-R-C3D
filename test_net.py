# CUDA_VISIBLE_DEVICES="0,1" ./script_test.sh c3d thumos14 --gpus 0 1 --bs 2 --nw 4 --checksession 1 --checkepoch 8 --checkpoint 6856
...
def parse_args():
    ...
    parser.add_argument('--checkpoint', default=6856, type=int,
    ...
    parser.add_argument('--roidb_dir', dest='roidb_dir', default="./preprocess",
                      help='roidb_dir')
    parser.add_argument('--gpus', dest='gpus', nargs='+', type=int, default=[0, 1],
                      help='gpu ids.')                        
